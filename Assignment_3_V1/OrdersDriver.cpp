...
int main() {
    ...
    tony->setPlayerStrategy( new AggressivePlayerStrategy(tony, europe));
    yacoub->setPlayerStrategy( new BenevolentPlayerStrategy(yacoub, europe));
    neutral->setPlayerStrategy( new NeutralPlayerStrategy(neutral, europe));
